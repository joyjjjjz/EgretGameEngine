/// <reference path="./display/ISwfAnimation.ts" />
import { App } from "../App";
import { ISwfAnimation } from "./display/ISwfAnimation";

/**
 * Created by zmliu on 14-5-11.
 */
// namespace starlingswf {

    /** 动画更新管理器 */
    export class SwfUpdateManager {
        private _animations: ISwfAnimation[];
        private _addQueue: ISwfAnimation[]; //添加队列
        private _removeQueue: ISwfAnimation[]; //移除队列
        private _fps: number;
