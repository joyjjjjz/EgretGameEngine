...
import { SwfUpdateManager } from "./SwfUpdateManager";
    ...
    export class Swf {
        ...
        //swf资源
        private _assetManager: SwfAssetManager;
        //动画更新器
        public swfUpdateManager: SwfUpdateManager;
        //该swf名称
        public name: string;
        constructor(swfData: Object, assetManager: SwfAssetManager, fps: number = 24) {
            ...
            this.swfUpdateManager = SwfUpdateManager.createSwfUpdateManager(fps);
        }
